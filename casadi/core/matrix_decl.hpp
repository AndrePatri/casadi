...
/// \endcond
  ...
  public:
    ...
    static DM evalf(const Matrix<Scalar>& m);
...
*/
    ...
    * An error is raised when the expression contains symbols
        ...
        \identifier{19a} */
    inline friend Matrix<Scalar> evalf(const Matrix<Scalar>& expr) {
...
/** @} */
  ...
  /// \endcond
    ...
    */
    ...
    static Matrix<Scalar> from_file(const std::string& filename, const std::string& format_hint="");
    //@}
